...
transformBusinessType = (entry) ->
  console.log "DEVELOPMENT ENVIRONMENT   Transforming business type " + entry.name_es
...
transformPageCategory = (entry) ->
  console.log "DEV ENVIRONMENT  Transforming page type " + entry.name_es
  entry.getLanguage = getLanguage
  entry.getLanguageUrl = getLanguageUrl
  entry.getAlternateUrl = getAlternateUrl
...
module.exports = 
  ...
  content_types:
    ...
    pages:
      id: 'page'
      filters: {'fields.section_page' : 'false',}
    ...
    businesses:
      ...
      filters:{'limit': '999','order': 'fields.title_en'}
      path: (e) -> [businessPath(e, "es"), businessPath(e, "en")] 
      transform: transformBusiness

    repeatEvents:
      id: 'repeatable_events'
      # filters: { 'order': 'fields.event_start_time', 'fields.event_start_time[gte]' : lastWeekIso, 'fields.event_start_time[lt]' : todayIso,}
    ...
    todaysEvents:
      id: 'event2'
      filters: { 'order': 'fields.event_start_time', 'fields.event_start_time[gte]' : todayIso, 'fields.event_start_time[lt]' : tomorrowIso }
      template: eventTemplate
      path: eventPath
      transform: transformEvent
    tomorrowsEvents:
      id: 'event2'
      filters: { 'order': 'fields.event_start_time', 'fields.event_start_time[gte]' : tomorrowIso, 'fields.event_start_time[lt]' : dayThreeIso }
      template: eventTemplate
      path: eventPath
      transform: transformEvent
    dayThreeEvents:
      id: 'event2'
      filters: { 'order': 'fields.event_start_time', 'fields.event_start_time[gte]' : dayThreeIso, 'fields.event_start_time[lt]' : dayFourIso }
      template: eventTemplate
      path: eventPath
      transform: transformEvent
     dayFourEvents:
      id: 'event2'
      filters: { 'order': 'fields.event_start_time', 'fields.event_start_time[gte]' : dayFourIso, 'fields.event_start_time[lt]' : dayFiveIso  }
      template: eventTemplate
      path: eventPath
      transform: transformEvent
    futureEvents:
      id: 'event2'
      filters: { 'order': 'fields.event_start_time', 'fields.event_start_time[gte]' : dayFiveIso }
      template: eventTemplate
      path: eventPath
      transform: transformEvent
    fortnightEvents:
      id: 'event2'
      filters: { 'order': 'fields.event_start_time', 'fields.event_start_time[gte]' : dayFiveIso,'fields.event_start_time[lt]' : fortnightIso }
      template: eventTemplate
      path: eventPath
      transform: transformEvent
    # blogPosts:
